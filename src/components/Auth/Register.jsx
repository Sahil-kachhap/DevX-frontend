...
const fileUploadStyle = cssStyle;
            ...
            <VStack h={'full'} justifyContent={'center'} spacing={'5'}>
                ...
                <form style={{ width: '100%' }}>
                    ...
                    <Box my={'4'}>
                        ...
                        <Input required id='password' value={password} onChange={(e) => setPassword(e.target.value)} placeholder='Enter your password here' type='password' focusBorderColor='yellow.500' />
                    </Box>
                    <Box my={'4'}>
                        <FormLabel htmlFor='chooseAvatar' children="Choose Avatar" />
                        <Input accept='image/*' onChange={imageHandler} required id='chooseAvatar' type='file' focusBorderColor='yellow.500' css={fileUploadStyle} />
                    </Box>
